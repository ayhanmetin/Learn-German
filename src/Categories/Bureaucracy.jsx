...
function WordApp() {
  // Initialize the state with a shuffled array of bureaucracy-tagged words
  const [filteredWords, setFilteredWords] = useState(() => {
    const bureaucracyWords = wordData.filter(
      word => word.tag === 'bureaucracy'
    );
    return shuffleArray([...bureaucracyWords]); // Use spread to create a new array instance
  });
