...
const WordDetail = () => {
  ...
  const word = wordData?.find(w => w?.word?.toLowerCase() === decodedWord.toLowerCase());
  ...
  if (!word) {
    return (
      <div className="text-center">
        ...
        <p>
          We couldn't find the word you're looking for. Please check the word or try another one.
        </p>
      </div>
    );
  }
